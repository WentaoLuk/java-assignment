...
/**
 * This class represents an Attack a character generates and contains a damage
 * score.
 * 
 * @see Character
 * @author piedas
...
public abstract class Attack {
	...
	/**
	 * This constructor sets the value specified into the damage field, no data
	...
	/**
	 * Sets the damage score for this atttack, no data validation is performed.
	 * 
	...
	/**
	 * This overridden toString() returns the name of the class, removing any
	 * package information with formatted text: <i>ClassName</i> with <i>%d</i>
	 * damage A newline character is not added to the end of the String.
	 */
	@Override
	public String toString() {
		...
		return String.format("%s with %d damage", className, getDamage());
	}
