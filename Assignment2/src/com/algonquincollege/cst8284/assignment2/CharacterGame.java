...
import com.algonquincollege.cst8284.assignment2.model.GnarledRootBeast;
import com.algonquincollege.cst8284.assignment2.model.MagicMoose;
...
public class CharacterGame {
	...
	// in here we need to change the constructor

	public CharacterGame() {
		for(int index = 0; index < 5; index++) {
			characters[index] = new MagicMoose();
		}
		for(int index = 5; index < 10; index++) {
			characters[index] = new GnarledRootBeast();
		}
	}
	...
	public void runGame() {
		...
		}while(fightAgain.equalsIgnoreCase("Y"));//ignore the case
	}
	...
	private void fight(int index1, int index2) {
		if (index1 == index2) {
			...
			Character one = characters[index1];//create a new charactor
	...
	private void conductFight(Character combatant1, Character combatant2) {
		...
		while (!stopFight) {
			...
			System.out.println("mark/Round: " + combatRoundCount);
